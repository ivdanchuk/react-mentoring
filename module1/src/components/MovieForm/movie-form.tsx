import {GENRES, IMovie} from "../../constants/сonstants";
...
export default function MovieForm({initialMovieInfo, onSubmit}: MovieFormProps) {
    const [movieInfo, setMovieInfo] =
        useState<IMovie>(initialMovieInfo ?? {
            poster: "",
            title: "",
            releaseYear: "",
            genres: [],
    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <select name="genres" value={movieInfo.genres[0]} onChange={handleGenresChange}>
